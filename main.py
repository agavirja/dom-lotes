...
with col2:
    ...
    highlight_function = lambda x: {'fillColor': '#2be6ee', 
                                'color':'#2be6ee', 
                                'fillOpacity': 0.50, 
                                'weight': 0.1}
    folium.GeoJson(datageometry,style_function=style_function_lotes,highlight_function=highlight_function).add_to(map0)
